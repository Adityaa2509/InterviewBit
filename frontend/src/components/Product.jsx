...
import { faEdit, faTrash, faSortUp, faSortDown, faPlus } from '@fortawesome/free-solid-svg-icons';
        ...
        <table className="table-auto border-collapse w-full ">
          <thead>
            <tr className="bg-gray-200 text-[#21295c]">
              <th className="px-4 py-2" onClick={() => toggleSort('id')}>ID {renderArrowIcon('id')}</th>
              <th className="px-4 py-2">Image</th>
              <th className="px-4 py-2" onClick={() => toggleSort('title')}>Title {renderArrowIcon('title')}</th>
              <th className="px-4 py-2" onClick={() => toggleSort('color')}>Color {renderArrowIcon('color')}</th>
              <th className="px-4 py-2" onClick={() => toggleSort('price')}>Price {renderArrowIcon('price')}</th>
              <th className="px-4 py-2" onClick={() => toggleSort('producer')}>Producer {renderArrowIcon('producer')}</th>
              <th className="px-4 py-2" onClick={() => toggleSort('createdAt')}>Created At {renderArrowIcon('createdAt')}</th>
              <th className="px-4 py-2" onClick={() => toggleSort('inStock')}>In Stock {renderArrowIcon('inStock')}</th>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
    <div className="bg-white p-8 rounded-lg text-[#21295c]">
      ...
      <form>
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1" htmlFor="color">Color</label>
          <input
            type="text"
            id="color"
            name="color"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1" htmlFor="price">Price</label>
          <input
            type="number"
            id="price"
            name="price"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1" htmlFor="producer">Producer</label>
          <input
            type="text"
            id="producer"
            name="producer"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1" htmlFor="inStock">In Stock</label>
          <input
            type="number"
            id="inStock"
            name="inStock"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold mb-1" htmlFor="image">Image URL</label>
          <input
            type="text"
            id="image"
            name="image"
