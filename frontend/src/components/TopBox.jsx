          ...
          <div className="listItem flex items-center justify-between mb-8" key={user.id}>
            <div className="user flex items-center gap-4">
              ...
              <div className="userTexts">
                <span className="username text-base lg:text-lg font-semibold">{user.username}</span>
                <span className="email text-sm lg:text-base hidden lg:block">{user.email}</span>
              </div>
            </div>
